...
- [<form.io>](https://form.io) - Implementation agnostic open-source REST API building via form builder ui. Contains open source and enterprise version. ([Demo](https://portal.form.io), [Source Code](https://github.com/orgs/formio)) `MIT` `NodeJS/TS`
